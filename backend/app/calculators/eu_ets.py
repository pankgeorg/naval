...
def calculate_eu_ets(
    ...
    return EUETSResult(
        ...
        ghg_scope=ghg_scope,
        total_covered_co2_t=round(total_covered_co2_t, 6),
        total_covered_ch4_co2eq_t=round(total_covered_ch4_co2eq_t, 6),
        total_covered_n2o_co2eq_t=round(total_covered_n2o_co2eq_t, 6),
        euas_required=round(euas_required, 6),
